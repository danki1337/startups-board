...
// Fourth main-page layout: a row of independent dropdown pills, one per filter (Title, Job type,
// Workplace, Country, City, Industry, ATS), plus a Search field and the date pill.
