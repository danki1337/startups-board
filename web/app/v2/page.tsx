...
// Second main-page layout: the same index and data path as the home page, rendered with the
// right-hand filter sidebar (variant="sidebar") instead of the compact top filter bar.
